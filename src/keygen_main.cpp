/*
 * 密钥生成工具
 * 用法: keygen_bin [--bits 2048] [--out-dir ./keys]
 * 生成: decrypt_private.pem, decrypt_public.pem, sign_private.pem, sign_public.pem
 */
